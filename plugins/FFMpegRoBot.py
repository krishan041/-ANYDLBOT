...
@pyrogram.Client.on_message(filters.command(["ffmpegrobot"]))
...
@pyrogram.Client.on_message(filters.command(["storageinfo"]))
...
@pyrogram.Client.on_message(filters.command(["clearffmpegmedia"]))
...
@pyrogram.Client.on_message(filters.command(["downloadmedia"]))
